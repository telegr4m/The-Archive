...
export default function ArchiveTimeline() {
  ...
  return (
    <section
      ref={sectionRef}
      className="overflow-hidden bg-black px-5 py-24 text-white sm:px-6 md:px-8 md:py-32"
    >
      <div className="mx-auto max-w-7xl">
        <p className="text-sm uppercase tracking-[0.4em] text-gray-400">
          Archive Timeline
        </p>
        <h2 className="mt-4 max-w-3xl text-4xl font-bold tracking-tight sm:text-5xl md:text-7xl">
        ...
        <div className="timeline-track relative mt-20">
            ...
            {timelineEntries.map((entry, index) => {
              ...
              return (
                ...
                >
                  ...
                  >
                    <div className="rounded-3xl border border-white/10 bg-white/[0.03] p-5 transition-colors duration-300 hover:border-white/25 hover:bg-white/[0.05] sm:p-7">
